  ...
  TaskingManagerLaunchConfiguration: {
    ...
    Properties: {
      ...
      UserData: cf.userData([
        ...
        'sudo apt-get -y install awscli curl git gnupg ruby wget',
        'sudo apt-get -y install python3.9 python3-pip python3-psycopg2 python-is-python3',
        'sudo apt-get -y install postgresql-client postgis libpq-dev',
        'sudo apt-get -y install libxml2 libxml2-dev',
        'sudo apt-get -y install libgeos-3.9.0 libgeos-dev',
        'sudo apt-get -y install libproj19 libproj-dev',
        ...
        'wget --quiet https://s3.amazonaws.com/cloudformation-examples/aws-cfn-bootstrap-py3-latest.tar.gz',
