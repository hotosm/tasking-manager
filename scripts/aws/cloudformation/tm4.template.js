  ...
  TaskingManagerLaunchConfiguration: {
    ...
    Properties: {
      ...
      UserData: cf.userData([
        ...
        cf.join('', ['sed -i -e "s|^POSTGRES_ENDPOINT=.*|POSTGRES_ENDPOINT=', cf.getAtt('TaskingManagerRDS','Endpoint.Address'), '|" /tasking-manager/example.env']),
        cf.sub('sed -i -e "s|^POSTGRES_DB=.*|POSTGRES_DB=${PostgresDB}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^POSTGRES_PASSWORD=.*|POSTGRES_PASSWORD=${PostgresPassword}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^POSTGRES_USER=.*|POSTGRES_USER=${PostgresUser}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_APP_BASE_URL=.*|TM_APP_BASE_URL=${TaskingManagerAppBaseUrl}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_APP_API_VERSION=.*|TM_APP_API_VERSION=${TaskingManagerApiVersion}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_CONSUMER_KEY=.*|TM_CONSUMER_KEY=${TaskingManagerConsumerKey}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_CONSUMER_SECRET=.*|TM_CONSUMER_SECRET=${TaskingManagerConsumerSecret}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_EMAIL_FROM_ADDRESS=.*|TM_EMAIL_FROM_ADDRESS=${TaskingManagerEmailFromAddress}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_LOG_DIR=.*|TM_LOG_DIR=${TaskingManagerLogDirectory}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_SECRET=.*|TM_SECRET=${TaskingManagerSecret}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_SMTP_HOST=.*|TM_SMTP_HOST=${TaskingManagerSMTPHost}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_SMTP_PASSWORD=.*|TM_SMTP_PASSWORD=${TaskingManagerSMTPPassword}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_SMTP_PORT=.*|TM_SMTP_PORT=${TaskingManagerSMTPPort}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_SMTP_USER=.*|TM_SMTP_USER=${TaskingManagerSMTPUser}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_DEFAULT_CHANGESET_COMMENT=.*|TM_DEFAULT_CHANGESET_COMMENT=${TaskingManagerDefaultChangesetComment}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_MATOMO_ID=.*|TM_MATOMO_ID=${MatomoSiteID}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_MATOMO_ENDPOINT=.*|TM_MATOMO_ENDPOINT=${MatomoEndpoint}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_MAPBOX_TOKEN=.*|TM_MAPBOX_TOKEN=${MapboxToken}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_NAME=.*|TM_ORG_NAME=${OrgName}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_CODE=.*|TM_ORG_CODE=${OrgCode}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_URL=.*|TM_ORG_URL=${OrgUrl}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_PRIVACY_POLICY=.*|TM_ORG_PRIVACY_POLICY=${OrgPrivacyPolicy}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_TWITTER=.*|TM_ORG_TWITTER=${OrgTwitter}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_FB=.*|TM_ORG_FB=${OrgFacebook}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_INSTAGRAM=.*|TM_ORG_INSTAGRAM=${OrgInstagram}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_YOUTUBE=.*|TM_ORG_YOUTUBE=${OrgYoutube}|" /tasking-manager/example.env'),
        cf.sub('sed -i -e "s|^TM_ORG_GITHUB=.*|TM_ORG_GITHUB=${OrgGitHub}|" /tasking-manager/example.env'),
        'source /tasking-manager/example.env',
