locals {
  envs = {
    ...
    TM_APP_BASE_URL               = get_env("TM_APP_BASE_URL", "https://tasks.hotosm.org")
    TM_APP_API_URL                = get_env("TM_APP_API_URL", "https://tasking-manager-production-api.hotosm.org/api")
    TM_REDIRECT_URI               = get_env("TM_REDIRECT_URI", "https://tasks.hotosm.org/authorized")
    ...
    OHSOME_STATS_BASE_URL         = get_env("OHSOME_STATS_BASE_URL", "https://ohsome-now.heigit.org")
    OHSOME_STATS_API_URL          = get_env("OHSOME_STATS_API_URL", "https://api.heigit.org/ohsome-now/v1")
