...
const pagerStyle = "f5 items-center br2 input-reset base-font bg-white button-reset justify-center no-underline  bg-animate hover-bg-blue-grey hover-white inline-flex items-center w2 h2 ba ma1 border-box";
...
export const ProjectCardPaginator = props => {
  ...
  const changeToPage = (value) => {
    apiIsFetched && props.setQueryParam(
      {
  ...
  <div className="flex items-center justify-center pa4">
    ...
    {maxPageMinusOne && maxPageMinusOne !== 2 && <PageButton pageNum={maxPageMinusOne} setPageFn={changeToPage}  activePage={activePage} />}
    {maxPage !== 1 && <PageButton pageNum={maxPage} setPageFn={changeToPage}  activePage={activePage}  />}
  </div>);
}
...
const PageButton = props => {
  ...
  return (
    <button href="#" onClick={() => props.setPageFn && props.setPageFn(props.pageNum)} className={`${currentStyle} ${pagerStyle} `}>
