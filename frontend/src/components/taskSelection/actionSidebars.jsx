...
function CompletionInstructions({ setVisibility }) {
  return (
...
export function ReopenEditor({ project, action, editor, callEditor }) {
...
export function UnsavedMapChangesModalContent({ close, action }) {
  return (
...
function TaskSplitErrorModalContent({ close }) {
  return (
    <div className="blue-dark bg-white pv2 pv4-ns ph2 ph4-ns tc">
