...
export function compareLastUpdate(
  a: {
    properties: {
  ...
  return differenceInMilliseconds(
    new Date(b.properties.actionDate),
    new Date(a.properties.actionDate),
  );
}

export function compareHistoryLastUpdate(
  a: {
    actionDate: string | number | Date;
  },
  b: {
