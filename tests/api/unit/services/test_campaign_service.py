...
from tests.api.helpers.test_helpers import create_canned_campaign, create_canned_project, create_canned_organisation
...
class TestCampaignService:
    ...
    async def setup_test_data(self, db_connection_fixture, request):
        ...
        # Preparar campaña, proyecto y organización base
    ...
    async def test_create_campaign_with_organisations(self):
        ...
        exists = await CampaignService.campaign_organisation_exists(campaign_id, self.test_org.id, self.db)
    ...
    async def test_delete_campaign_removes_associations(self):
        ...
        await CampaignService.create_campaign_organisation(self.test_org.id, self.campaign.id, self.db)
    ...
    async def test_delete_organisation_campaign_raises_error_if_not_associated(self):
        ...
        with pytest.raises(NotFound, match="ORGANISATION_CAMPAIGN_NOT_FOUND"):
            await CampaignService.delete_organisation_campaign(self.test_org.id, self.campaign.id, self.db)
