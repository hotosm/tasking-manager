...
class TestMessagingService(BaseTestCase):
    ...
    def test_message_service_generates_correct_chat_link(self):
        ...
        link = MessageService.get_project_link(
            1, "Test Project", "http://test.com", include_chat_section=True
        )

        self.assertEqual(
            link,
            '<a href="http://test.com/projects/1#questionsAndComments">Test Project</a>',
        )
        link = MessageService.get_project_link(
            1,
            "Test Project",
        ...
        self.assertEqual(
            link,
            '<a href="http://test.com/projects/1">Test Project</a>',
        )
