...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": r"0.15.0",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-3bfntp2g\overlay\Lib\site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-ohobiy3m\cp310-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.10",
        },
    }
)
