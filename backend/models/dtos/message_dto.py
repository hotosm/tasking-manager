...
class MessageDTO(Model):
    ...
    subject = StringType(serialized_name="subject", required=True, serialize_when_none=False)
    message = StringType(serialized_name="message", required=True, serialize_when_none=False)
