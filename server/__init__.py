...
def init_flask_restful_routes(app):
    ...
    from server.api.user_apis import UserAPI, UserOSMAPI, UserMappedProjects, UserAddRole
    ...
    api.add_resource(UserAddRole,                   '/api/v1/user/<string:username>/add-role/<string:role>')
