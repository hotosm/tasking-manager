...
def init_flask_restful_routes(app):
    ...
    api.add_resource(CampaignProjectAPI,            '/api/v1/project/campaign', methods=['POST', 'DELETE'])
    api.add_resource(CreateAndSetCampaignAPI,       '/api/v1/project/campaign/create/<int:project_id>', methods=['POST'])
