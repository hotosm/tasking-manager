...
def init_flask_restful_routes(app):
    ...
    from server.api.users.authentication_apis import LoginAPI, OAuthAPI, AuthEmailAPI, TokenGenerationAPI
    ...
    api.add_resource(TokenGenerationAPI,            '/api/v1/auth/generate-token')
