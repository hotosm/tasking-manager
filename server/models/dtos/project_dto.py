...
class ProjectDTO(Model):
    ...
    total_tasks = IntType(serialized_name='total_tasks')
    tasks_mapped = IntType(serialized_name='tasks_mapped')
    tasks_validated = IntType(serialized_name='tasks_validated')
    tasks_bad_imagery = IntType(serialized_name='tasks_bad_imagery')
