...
class Task(db.Model):
    ...
    archived_by = db.Column(db.BigInteger, db.ForeignKey('users.id', name='fk_users_archived'))
    ...
    def unarchive_task(self, user_id, new_state=None, comment=None, undo=False, issues=None):
        ...
        if new_state in [TaskStatus.MAPPED, TaskStatus.BADIMAGERY] and TaskStatus(self.task_status) != TaskStatus.ARCHIVED:
