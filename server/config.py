...
class EnvironmentConfig:
    ...
    SUPPORTED_LANGUAGES = {
        'codes': 'ar, cs, da, de, en, es, fi, fr, hu, id, it, ja, lt, mg, nb, nl_NL, pl, pt, pt_BR, ru, si, sl, ta, uk, zh_TW',
        'languages': 'Arabic, Česky, Dansk, Deutsch, English, Español, Suomi, Français, Magyar, Indonesia, Italiano, 日本語, Lietuvos, Malagasy, Bokmål, Nederlands, Polish, Português, Português (Brasil), Русский, සිංහල, Slovenščina, தமிழ், Українська, 中文'
    }
