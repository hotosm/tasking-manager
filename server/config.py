...
class EnvironmentConfig:
    ...
    SUPPORTED_LANGUAGES = {
        'codes': 'ar, cs, da, de, en, es, fa_IR, fr, hu, gl, id, it, ja, lt, mg, nb, nl_NL, pl, pt, pt_BR, ru, si, sl, ta, uk, vi, zh_TW',
        'languages': 'Arabic, Česky, Dansk, Deutsch, English, Español, Persian (Iran), Français, Magyar, Galician, Indonesia, Italiano, 日本語, Lietuvos, Malagasy, Bokmål, Nederlands, Polish, Português, Português (Brasil), Русский, සිංහල, Slovenščina, தமிழ், Українська, tiếng Việt, 中文'
    }
