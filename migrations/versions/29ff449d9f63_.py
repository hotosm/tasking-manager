...
Revision ID: 29ff449d9f63
Revises: 58f514394c00
Create Date: 2017-03-29 11:06:51.600574
...
def upgrade():
    ...
    op.create_foreign_key('fk_tasks', 'task_history', 'tasks', ['task_id', 'project_id'], ['id', 'project_id'])
...
def downgrade():
    ...
    op.drop_constraint('fk_tasks', 'task_history', type_='foreignkey')
