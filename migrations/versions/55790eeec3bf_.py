...
def upgrade():
    ...
    op.alter_column("notifications", "date", existing_type=postgresql.TIMESTAMP(), nullable=True)
    op.alter_column("notifications", "unread_count", existing_type=sa.INTEGER(), nullable=True)
    op.alter_column("notifications", "user_id", existing_type=sa.BIGINT(), nullable=True)
    ...
    op.create_index(op.f("ix_tasks_validated_by"), "tasks", ["validated_by"], unique=False)
...
def downgrade():
    ...
    op.alter_column("notifications", "user_id", existing_type=sa.BIGINT(), nullable=False)
    op.alter_column("notifications", "unread_count", existing_type=sa.INTEGER(), nullable=False)
    op.alter_column("notifications", "date", existing_type=postgresql.TIMESTAMP(), nullable=False)
    # ### end Alembic commands ###
