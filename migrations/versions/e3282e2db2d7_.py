...
def downgrade():
    ...
    op.add_column('projects', sa.Column('organisation_tag', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_constraint('fk_organisations', 'projects', type_='foreignkey')
    op.create_index('ix_projects_organisation_tag', 'projects', ['organisation_tag'], unique=False)
