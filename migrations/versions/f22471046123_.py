...
Revision ID: f22471046123
Revises: b93421cec5bd
Create Date: 2017-03-16 10:27:50.884696
...
def downgrade():
    ...
    op.add_column('projects', sa.Column('name', sa.VARCHAR(length=256), autoincrement=False, nullable=True))
    op.alter_column('projects', 'status',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('projects', 'created',
