...
def upgrade():
    ...
    op.alter_column("projects", "mapper_level", nullable=False, new_column_name="difficulty")
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("projects", "difficulty", nullable=False, new_column_name="mapper_level")
