...
| **CP-4003-03** | 1. Visualizar una tarea `VALIDATED` cuya evaluación final fue efectuada por OTRO usuario.<br>2. Intentar Deshacer (Undo) su acción mediante el botón "Solicitar revalidación". | **Propiedad:** Tercero | El sistema permite la acción; al contar con el rol de Validator, el botón "Solicitar revalidación" debe estar visible y habilitado, permitiendo revertir tareas validadas por otros usuarios. |
