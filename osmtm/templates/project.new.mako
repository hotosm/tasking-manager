...
<script src="${request.static_url('osmtm:static/js/lib/leaflet-omnivore.min.js', _query={'v':'2.6-dev'})}"></script>
<script src="${request.static_url('osmtm:static/js/project.new.js', _query={'v':'2.6-dev'})}"></script>
  ...
  <div class="row">
    <div class="col-md-6">
      <label class="radio">
        ...
        Square Grid
        <br>
        <img src="${request.static_url('osmtm:static/img/project_creation_grid.png', _query={'v':'2.6-dev'})}" width="150">
        <p class="help-block">
    ...
    <div class="col-md-6">
      <label id="arbitrary" class="radio mask"
        ...
        <br>
        <img src="${request.static_url('osmtm:static/img/project_creation_arbitrary.png', _query={'v':'2.6-dev'})}" width="150">
        <p class="help-block">
