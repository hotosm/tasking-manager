...
<html>
  <head>
    ...
    <link rel="stylesheet" href="${request.static_url('osmtm:static/css/main.css', _query={'v':'2.4.2'})}">
    <link rel="stylesheet" href="${request.static_url('osmtm:static/js/lib/leaflet.css', _query={'v':'2.4.2'})}">
    <script src="${request.static_url('osmtm:static/js/lib/jquery-1.7.2.min.js', _query={'v':'2.4.2'})}"></script>
    <script src="${request.static_url('osmtm:static/js/lib/showdown.js', _query={'v':'2.4.2'})}"></script>
    <script src="${request.static_url('osmtm:static/js/lib/jquery-timeago/jquery.timeago.js', _query={'v':'2.4.2'})}"></script>
    <script src="${request.static_url('osmtm:static/js/lib/jquery-timeago/locales/jquery.timeago.%s.js' % request.locale_name, _query={'v':'2.4.2'})}"></script>
    <script src="${request.static_url('osmtm:static/js/lib/sammy-latest.min.js', _query={'v':'2.4.2'})}"></script>
    <script src="${request.static_url('osmtm:static/js/shared.js', _query={'v':'2.4.2'})}"></script>
    <script src="${request.static_url('osmtm:static/bootstrap/dist/js/bootstrap.min.js', _query={'v':'2.4.2'})}"></script>
<%
