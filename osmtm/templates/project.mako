...
<script src="${request.static_url('osmtm:static/js/lib/Leaflet.utfgrid/dist/leaflet.utfgrid.js', _query={'v':'2.3.0'})}"></script>
<script>
<%
...
var commentRequiredMsg = "${_('You must leave a comment.')}"
  ...
  <script type="text/javascript" src="${request.static_url('osmtm:static/js/project.js', _query={'v':'2.3.0'})}"></script>
</%block>
